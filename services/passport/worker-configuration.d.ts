/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface PassportEnv` (hash: fe440afa245defc9476f700d60025e61)
// Runtime types generated with workerd@1.20250617.0 2025-05-25 
declare namespace Cloudflare {
	interface Env {
		KV_PASSPORT: KVNamespace;
		REFRESH_TOKEN_SECRET: string;
		REFRESH_TOKEN_ISSUER: string;
		ACCESS_TOKEN_SECRET: string;
		ACCESS_TOKEN_ISSUER: string;
		PRODUCT_AUDIENCE_MINERVA: string;
	}
}
